...
// ----------------------------------------------------------------------------
void
modm::platform::Timer4::clockEnable()
{
	enable();
}

void
modm::platform::Timer4::enable()
{
	Rcc::enable<Peripheral::Tim4>();
}

void
modm::platform::Timer4::disable()
{
	TIM4->CR1 = 0;
	TIM4->DIER = 0;
	TIM4->CCER = 0;
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer4::configureInputChannel(uint32_t channel,
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer4::enableInterruptVector(bool enable, uint32_t priority)
{
	if (enable)
	{
