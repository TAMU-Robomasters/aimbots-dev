...
//         POWER_COM_DATA::POWER_COM_MASTER::connect<modm::platform::GpioOutputB13::Sck,modm::platform::GpioOutputB15::Mosi,modm::platform::GpioInputB14::Miso>();
//         POWER_COM_DATA::POWER_COM_MASTER::initialize<Board::SystemClock, modm::MBd(10)>();
...
//         receivedData = POWER_COM_DATA::POWER_COM_MASTER::transferBlocking(receivedData);
//         POWER_COM_DATA::SPI_CS::set();
//     }
