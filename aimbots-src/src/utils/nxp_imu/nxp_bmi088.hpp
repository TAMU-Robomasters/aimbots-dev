...
class NXPBMI088 : public Bmi088Data, public ImuInterface {
   public:
    ...
    mockable virtual inline float getYaw() final_mockable { return nxpAlgorithm.getYaw(); }
    mockable virtual inline float getPitch() final_mockable { return nxpAlgorithm.getPitch(); }
    mockable virtual inline float getRoll() final_mockable { return nxpAlgorithm.getRoll(); }

    mockable virtual inline float getGx() final_mockable { return data.gyroDegPerSec[ImuData::X]; }  // gyro
    mockable virtual inline float getGy() final_mockable { return data.gyroDegPerSec[ImuData::Y]; }
    mockable virtual inline float getGz() final_mockable { return data.gyroDegPerSec[ImuData::Z]; }

    mockable virtual inline float getAx() final_mockable { return data.accG[ImuData::X]; }  // aceleramoter
    mockable virtual inline float getAy() final_mockable { return data.accG[ImuData::Y]; }
    mockable virtual inline float getAz() final_mockable { return data.accG[ImuData::Z]; }

    mockable virtual inline float getTemp() final_mockable { return data.temperature; }
