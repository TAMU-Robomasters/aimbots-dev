...
void NXPBMI088::requestRecalibration()
{
...
void NXPBMI088::initialize(float sampleFrequency)
{
    ...
    nxpAlgorithm.begin(sampleFrequency);
}

void NXPBMI088::initializeAcc()
{
...
void NXPBMI088::setAndCheckAccRegister(Acc::Register reg, Acc::Registers_t value)
{
...
void NXPBMI088::setAndCheckGyroRegister(Gyro::Register reg, Gyro::Registers_t value)
{
