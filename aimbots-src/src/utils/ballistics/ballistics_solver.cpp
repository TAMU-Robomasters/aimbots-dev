...
std::optional<BallisticsSolver::BallisticsSolution> BallisticsSolver::solve(std::optional<float> projectileSpeed) {
    nothingSeenDisplay = drivers->cvCommunicator.getLastValidAimMessage().cvState == src::Informants::Vision::CVState::NO_TARGET;
    jetsonOnlineDisplay = !drivers->cvCommunicator.isJetsonOnline();
    if (!drivers->cvCommunicator.isJetsonOnline() ||
        drivers->cvCommunicator.getLastValidAimMessage().cvState == src::Informants::Vision::CVState::NO_TARGET) {
