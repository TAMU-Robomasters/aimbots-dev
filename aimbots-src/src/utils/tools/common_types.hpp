...
enum SongTitle : uint8_t { NONE = 0, PACMAN, WE_ARE_NUMBER_ONE, CHAINSAW_MAN, MYSTERY, CRAB_RAVE, ZELDA, LG_WASH, DUNE, FREEBIRD, BADPIGGIES, BOONIE, WEENWAO, GIORNOTHEME, GRANNY, TERRARIA, CAN_YOU_HEAR_THE_DUB, FALLEN_DOWN, RED_BARON, WAR_HYMN};
