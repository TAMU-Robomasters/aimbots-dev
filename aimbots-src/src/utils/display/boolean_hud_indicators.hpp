...
public:
    BooleanHudIndicator(tap::control::CommandScheduler &commandScheduler, tap::communication::serial::RefSerialTransmitter &refSerialTransmitter);
...
private:
    ...
    static constexpr BooleanHUDIndicatorTuple BOLEAN_HUD_INDICATOR_LABELS_AND_COLORS[NUM_BOOLEAN_HUD_INDICATORS]{
        BooleanHUDIndicatorTuple("SYSTEMS CALIBRATING", Tx::GraphicColor::WHITE, Tx::GraphicColor::BLACK),
