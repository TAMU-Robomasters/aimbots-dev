...
void KinematicInformant::registerSubsystems(src::Chassis::ChassisSubsystem* chassisSubsystem) {
    this->chassisSubsystem = chassisSubsystem;
...
void KinematicInformant::registerSubsystems(src::Gimbal::GimbalSubsystem* gimbalSubsystem) {
    this->gimbalSubsystem = gimbalSubsystem;
