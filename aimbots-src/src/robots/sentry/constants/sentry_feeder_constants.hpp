...
static constexpr int UNJAM_TIMER_MS = 75;
...
static const std::array<float, FEEDER_MOTOR_COUNT> FEEDER_NORMAL_RPMS = {2000.0f};
static const std::array<float, FEEDER_MOTOR_COUNT> FEEDER_UNJAM_RPMS = {4000};  // Absolute values
