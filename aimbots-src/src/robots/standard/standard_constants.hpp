...
static constexpr float YAW_START_ANGLE = 37.91f;    // original angles that should be zero when 6020 is mounted to chassis 
static constexpr float PITCH_START_ANGLE = 118.34f;
