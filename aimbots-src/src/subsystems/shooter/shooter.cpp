...
ShooterSubsystem::ShooterSubsystem(tap::Drivers* drivers)
    : Subsystem(drivers),
      ...
      flywheel1PID(SHOOTER_PID_KP, SHOOTER_PID_KI, SHOOTER_PID_KD, SHOOTER_MAX_I_CUMULATIVE, SHOOTER_MAX_OUTPUT, SHOOTER_TQ_DERIVATIVE_KALMAN, SHOOTER_TR_DERIVATIVE_KALMAN,  SHOOTER_TQ_PROPORTIONAL_KALMAN , SHOOTER_TR_PROPORTIONAL_KALMAN ),
      flywheel2PID(SHOOTER_PID_KP, SHOOTER_PID_KI, SHOOTER_PID_KD, SHOOTER_MAX_I_CUMULATIVE, SHOOTER_MAX_OUTPUT, SHOOTER_TQ_DERIVATIVE_KALMAN, SHOOTER_TR_DERIVATIVE_KALMAN,  SHOOTER_TQ_PROPORTIONAL_KALMAN , SHOOTER_TR_PROPORTIONAL_KALMAN ),
#ifdef TARGET_SENTRY
      ...
      flywheel3PID(SHOOTER_PID_KP, SHOOTER_PID_KI, SHOOTER_PID_KD, SHOOTER_MAX_I_CUMULATIVE, SHOOTER_MAX_OUTPUT, SHOOTER_TQ_DERIVATIVE_KALMAN, SHOOTER_TR_DERIVATIVE_KALMAN,  SHOOTER_TQ_PROPORTIONAL_KALMAN , SHOOTER_TR_PROPORTIONAL_KALMAN ),
      flywheel4PID(SHOOTER_PID_KP, SHOOTER_PID_KI, SHOOTER_PID_KD, SHOOTER_MAX_I_CUMULATIVE, SHOOTER_MAX_OUTPUT, SHOOTER_TQ_DERIVATIVE_KALMAN, SHOOTER_TR_DERIVATIVE_KALMAN,  SHOOTER_TQ_PROPORTIONAL_KALMAN , SHOOTER_TR_PROPORTIONAL_KALMAN ),
#endif
