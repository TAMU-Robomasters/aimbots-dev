...
//     tap::communication::serial::RefSerialTransmitter &refSerialTransmitter, const ChassisSubsystem &chassis
...
//     for (HUDIndicatorIndexInit = 0; HUDIndicatorIndexInit < NUM_BOOLEAN_HUD_INDICATORS; HUDIndicatorIndexInit++) {
